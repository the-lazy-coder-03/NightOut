...
public class ClubService {
    ...
    @Transactional
    public Club create(String name, String slug, String city, String address, String logoUrl, String storageFolderId, boolean active) {
        Club club = new Club();
        apply(club, name, slug, city, address, logoUrl, storageFolderId, active);
        return clubRepository.save(club);
    }

    @Transactional
    public Club update(Long id, String name, String slug, String city, String address, String logoUrl, String storageFolderId, boolean active) {
    ...
    private void apply(Club club, String name, String slug, String city, String address, String logoUrl, String storageFolderId, boolean active) {
