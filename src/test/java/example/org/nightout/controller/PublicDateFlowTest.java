...
class PublicDateFlowTest {
    ...
    void dateGalleryShowsUploadButtonAbovePhotosAndPromptChoices() throws Exception {
        String html = mockMvc.perform(get("/clubs/halo/dates/2026-08-07"))
                ...
                .andExpect(content().string(containsString("data-gallery-share=\"/photos/" + haloFridayPhoto.getId() + "\"")))
                ...
                .andExpect(content().string(containsString("data-bulk-download-url=\"/photos/download\"")))
                .andExpect(content().string(containsString("data-photo-select")))
                .andExpect(content().string(containsString("value=\"" + haloFridayPhoto.getId() + "\"")))
                .andExpect(content().string(containsString("data-share-url=\"/photos/" + haloFridayPhoto.getId() + "\"")))
